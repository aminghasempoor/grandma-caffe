...
export function AddDiscount() {
    ...
    const onSubmit = async (data: EditUserFormValues) => {
        try {
            await requestServer(`${GET_DISCOUNT_DETAIL}`, "post", {
    ...
    return (
        ...
        >
            ...
            <DialogContent className="p-5">
                <DialogHeader>
                    <DialogTitle className="text-start">{t("add")}</DialogTitle>
                    <DialogDescription className="text-start py-0 pt-2">{t("add_description")}</DialogDescription>
                </DialogHeader>
